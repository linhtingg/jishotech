...
if (isset($_POST['signup'])) {
    ...
    $email = $_POST['email'];
    $pass = $_POST['pass'];
    $ret = mysqli_query($con, "INSERT INTO user (username,email,pass) VALUES ('$username','$email','$pass');");
                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light py-5 px-4 px-sm-5">
                            <h3 style="color:white; text-align: center;">サインアップ</h3>
                            <p style="color:white; text-align: center;">新しいアカウントを作る</p>
                            <form class="pt-3" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg border-left-0" id="email"
                                        placeholder="電子メールアドレス" name="email">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="mt-3" style="text-align: center">
                                    <button type="submit"
                                        ...
                                        name="signup">
                                        <span style="color: white">サインアップ</span>
                                    </button>
                                </div>
